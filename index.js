...
그룹웨어 Works에서 '(AMI) 법인 인감 및 서류 신청' 앱을 선택해서 작성해주세요. 작성 후 @hjun 에게 알림이 가도록 태그해주세요.`,
  ...
  {
    keywords: ['NAS', 'nas', '나스', '서버 접속', '서버접속', '서버 사용'],
    context: `[관련 사내 정책 - 반드시 아래 내용으로 답변하세요]
**🖥️ 사무실 내 접속 (웹)**
- 접속 주소: http://10.10.3.8
- 사무실 외부에서는 접속 불가 (사무실 IP 대역만 허용)

**🌐 사무실 외부에서 접속이 필요한 경우**
- 접속 주소: w1939.synology.me:56330
- ⚠️ 단, 외부 접속 시 속도가 현저히 저하될 수 있어요

**🔑 계정 정보**
- ID: 본인 성명
- PW: 모르시는 경우 운영팀으로 문의해주세요
  (첫 입사 시 운영팀에서 함께 패스워드 세팅 진행합니다)

**📁 폴더 동기화가 필요한 경우 (Windows)**
1. 윈도우 하단 돋보기(검색) 버튼 클릭
2. '실행' 입력 후 실행 앱 열기
3. \\\\10.10.3.8 입력
4. ID / PW는 웹 접속과 동일하게 입력
5. 필요한 최상위 폴더를 바탕화면에 바로가기로 만들어 사용`,
  },
  {
